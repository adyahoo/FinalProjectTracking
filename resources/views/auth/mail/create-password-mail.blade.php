...
<body>
    <div>
                                ...
                                <table border='0' cellpadding='0' cellspacing='0' role='presentation' style='vertical-align:top;' width='100%'>
                                    <tr>
                                        <td align='center' style='font-size:0px;padding:10px 25px;padding-bottom:5px;word-break:break-word;'>
                                            <img alt='Logo' height='auto' src='https://i.ibb.co/CM4NNTR/Timedoor-Logo.png' style='border:none;display:block;outline:none;text-decoration:none;height:50%;width:50%;' width='100' />
                                        </td>
                                    </tr>
                                </table>
                            </div>
        ...
        <![endif]-->
        <table align='center' border='0' cellpadding='0' cellspacing='0' role='presentation' style='background:#F9FDFF;background-color:#F9FDFF;width:100%;'>
            <tbody>
                <tr>
                    <td>

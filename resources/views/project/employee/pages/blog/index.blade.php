            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>My Blogs</h4>
                        <a href="{{ route('employee.blogs.create') }}" class="btn btn-primary btn-round ml-auto btn-add text-white">
                                    ...
                                    @foreach($blogs as $blog)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form id="del{{ $blog->id }}" action="{{ route('employee.blogs.destroy', $blog) }}" method="post">
                                                    @method('delete')
                                                    @csrf
                                                </form>
                                            </td>

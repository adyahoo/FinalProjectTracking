...
<div class="section-header">
    <div class="section-header-back">
        <a href="{{route('employee.profile.profile')}}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
    </div>
    <h1>Change Password</h1>
</div>

<div class="section-body">
    <form id="pass" action="{{route('employee.profile.change-password.submit')}}" enctype="multipart/form-data" method="POST">
        @csrf
        @method('PUT')

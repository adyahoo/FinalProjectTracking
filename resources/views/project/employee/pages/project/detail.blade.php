                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-1 text-right">
                            <a href="{{ route('employee.projects.edit', $project) }}" class="h5" style="color: #78828a"><i class="fa fa-edit"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            @else
                                <div class="row">
                                    ...
                                    <div class="col-3 text-right">
                                        <a href="#" data-action="{{ route('employee.projects.addLaunchDate', $project) }}" data-detail="{{ $project->launch_date->format('Y-m-d') }}" class="btn-edit" data-toggle="modal" data-target="#modal" class="h5" style="color: #78828a"><i class="fa fa-edit"></i></a>
                                    </div>
                                </div>
                            @endempty
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                <a href="{{ route('employee.projects.module.all', $project) }}" class="btn btn-primary"><i class="fas fa-plus"></i></a>
                            </div>
                        </div>
                        <div class="card-body">

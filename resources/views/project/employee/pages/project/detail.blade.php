                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-3 col-sm-12 text-right">
                                    ...
                                    @empty($request->version)
                                        <a href="{{ route('employee.projects.gantt_chart.index', ['project' => $project, 'version' => $selectedVersion->id]) }}" class="btn btn-outline-primary" style="border-radius:.25rem">View Gantt Chart <i class="fa fa-external-link-alt"></i></a>
                                    @else
                                        <a href="{{ route('employee.projects.gantt_chart.index', ['project' => $project, 'version' => $request->version]) }}" class="btn btn-outline-primary" style="border-radius:.25rem">View Gantt Chart <i class="fa fa-external-link-alt"></i></a>
                                    @endempty
                                </div>
                            </div>
                        </div>

            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-header-action">
                        ...
                        <button data-action="{{ route('project_manager.projects.module.create_special', $project) }}" class="btn btn-outline-primary btn-round ml-auto btn-special-module" data-toggle="modal" data-target="#specialModule">
                            <i class="fa fa-plus"></i>
                            Add Special Module
                        </button>
                    </div>
                                ...
                                @foreach($project->project_versions as $version)
                                    @foreach($version->project_details as $projectDetail)
                                        <tr>
                                            ...
                                            <td>
                                                <a data-detail="{{ route('project_manager.projects.module.show', $project, $projectDetail->moduleable) }}" href="#" class="btn btn-primary btn-edit" data-toggle="modal" data-target="#modal"><i class="fa fa-pencil-alt"></i></a>
...
@section('modal')
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6 col-lg-6">
                                ...
                                <input value="{{ old('start_date') }}" id="moduleStart" type="date" name="start_date" class="form-control">
                                @error('start_date')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="form-group col-md-6 col-lg-6">
                                ...
                                <input value="{{ old('end_date') }}" id="moduleEnd" type="date" name="end_date" class="form-control">
                                @error('end_date')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="specialModule">
        <div class="modal-dialog" role="document">

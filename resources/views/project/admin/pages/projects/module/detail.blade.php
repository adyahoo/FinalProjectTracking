        ...
        <div class="col-lg-4 col-md-4 col-sm-12">
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="row mt-4">
                        <button data-action="{{ route('admin.admin_projects.project_module.update', $projectDetail) }}" data-detail="{{ route('admin.admin_projects.project_module.edit', $projectDetail) }}" title="Add Actual Date" class="btn btn-primary btn-round mx-auto mt-2 btn-add-actual-date text-white" data-toggle="modal" data-target="#modalDateActual">
                            @empty($projectDetail->start_date_actual)
                                <i class="fa fa-plus"></i>
                                Add Actual Date
                            @else

...
class ProfileController extends Controller
{
    ...
    public function index() {
        ...
        return view('project.employee.pages.dashboard.profile', compact('blogCount', 'blogViewCount', 'assignmentCount'));
    }

    public function changePasswordPages() {
        return view('project.employee.pages.dashboard.change_password');
    }
